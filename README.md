...
| `Main.jsx`         | Contains MSAL React Components and main sample content |
...
**Note:** This sample was bootstrapped using [Create React Main](https://github.com/facebook/create-react-app).
